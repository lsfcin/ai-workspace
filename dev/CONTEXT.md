...
|------|-----------|-------------|
| `project/SPECS.md` | about to write code; debugging; checking constraints | new dep; architecture change; constraint added |
| `project/ROADMAP.md` | planning next work; milestone review | milestone completed |
